# from https://github.com/milesial/Pytorch-UNet/blob/master/unet
...
class UNet(LoadableModel):
    @store_config_args
    def __init__(self, n_channels: int, n_classes: int, bilinear: bool = False, n_last_channel: int = 64):
        """
        classic U-Net architecture
        :param n_channels: number of input channels
        :param n_classes: number of output classes = number of output channels
        :param bilinear: wether to use bilinear interpolation or transposed convolutions for upsampling
        :param n_last_channel: number of channels before the last convolution
        """
        ...
        self.up4 = (Up(128, n_last_channel, bilinear))
        self.outc = (OutConv(n_last_channel, n_classes))
